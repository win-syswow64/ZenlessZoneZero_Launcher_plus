...
namespace ZenlessZoneZero_Launcher_plus.ViewModels
{
    ...
    public class SettingsPageViewModel : ObservableObject
    {
        ...
        {
            string GaGamePath = Path.Combine(GamePath, "ZenlessZoneZero.exe");
            if (GamePath != "" && File.Exists(GaGamePath))
            {
        ...
        private async Task GameFileConvert()
        {
            ...
            if (!fileHelper.IsFileOpen(Path.Combine(App.Current.DataModel.GamePath, "ZenlessZoneZero.exe")) )
            {
