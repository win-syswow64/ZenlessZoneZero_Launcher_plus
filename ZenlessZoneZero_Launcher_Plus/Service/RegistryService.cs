...
namespace ZenlessZoneZero_Launcher_plus.Service
{
    ...
    {
        private const string CnPathKey = @"HKEY_CURRENT_USER\Software\miHoYo\绝区零";
        private const string CnSdkKey = "MIHOYOSDK_ADL_PROD_CN_h3123967166";
        private const string GlobalPathKey = @"HKEY_CURRENT_USER\Software\miHoYo\ZenlessZoneZero";
